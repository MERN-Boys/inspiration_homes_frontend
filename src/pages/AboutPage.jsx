      ...
      <div className="jumbotron jumbotron-fluid">
        <div className="container">
          <div>
            ...
            <p className="lead">
              OUR COMMITMENT For us here At Inspiration Homes, we are committed
              ...
              <p className="lead">
              WHY BUILD
              WITH US We understand the privilege of building your new home, and
